...
namespace Services
{
    public class BookManager : IBookService
    {
        ...
        public BookManager(IRepositoryManager manager, ILoggerService logger, IMapper mapper, IBookLinks booksLink, ICategoryService categoryService)
        {
            _manager = manager;
            _logger = logger;
            _mapper = mapper;
            _booksLinks = booksLink;
        ...
        public async Task<(LinkResponse linkResponse, MetaData metaData)> 
            GettAllBooksAsync(LinkParameters linkParameters,
            bool trackChanges)
        {
            ...
            var links = _booksLinks.TryGenerateLinks(booksDto,
        ...
        public async Task<List<Book>> GettAllBooksAsync(bool trackChanges)
        {
